...
# 	sys.exit(0) 
	...
	fig.savefig(os.path.join("out", "prob2b", 'training_loss_{0}_{1}_{2}.png'.format(step_size, reg, h)))
	...
	plt.title("step size={0}, reg={1}, h={2}".format(step_size,reg,h))
	fig.savefig(os.path.join("out", "prob2b", 'validation_loss_{0}_{1}_{2}.png'.format(step_size, reg, h)))
	
	
f = open(os.path.join("out", "prob2b", "result"), "w")
